...
//
// public class NatsumeAiCommandModule(NatsumeIntelligenceService natsumeIntelligenceService) : ApplicationCommandModule<ApplicationCommandContext>
// {
...
//         var response = await natsumeIntelligenceService.GetChatCompletionTextAsync(aiModel, ContactNickname, request);
...
//
//         var reactions = await natsumeIntelligenceService.GetFriendChatCompletionReactionsAsync(
//             aiModel: aiModel,
...
//         await RespondAsync(InteractionCallback.DeferredMessage(MessageFlags.Ephemeral));
//
//         var completionText = await natsumeIntelligenceService.GetFriendChatCompletionTextAsync(
//             aiModel,
//             Context.User.Id,
//             ContactNickname,
//             request
...
//         await RespondAsync(InteractionCallback.DeferredMessage());
//
//         var completion = await natsumeIntelligenceService.GetFriendImageCompletionAsync(
//             model,
//             Context.User.Id,
//             ContactNickname,
//             imageDescription
